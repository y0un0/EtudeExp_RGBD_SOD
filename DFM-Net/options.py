...
def save_path():
    run = 0
    save_folder = "/content/DFM-Net/results/demo-%s-%s-%d" % (time.strftime("%m"), time.strftime("%d"), run)
...
parser.add_argument('--root', type=str, default='/content/RGBDcollection', help='the training rgb images root')
