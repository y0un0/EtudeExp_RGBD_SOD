...
def main():
    ...
    l, train_time = train(net, optimizer)
    plt.plot(np.arange(1, args['iter_num'] + 1), l)
    plt.xlabel('Iterations')
    plt.ylabel('Total loss')
    plt.title('DANet learning curve | train time: '+str(train_time)+'s')
    plt.savefig('DANet_learning_curve.jpg', dpi=300)
...
def train(net, optimizer):
    ...
    while True:
        ...
        for i, data in enumerate(train_loader):
            ...
            l.append(total_loss_record.avg)
            print(log)
