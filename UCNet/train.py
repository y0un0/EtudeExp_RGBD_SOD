...
# save csv loss
def save_csv(loss_list, train_time):
  df = pd.DataFrame({'loss': loss_list})
  df.to_csv('UCNet_training_loss_'+str(train_time)+'_s.csv')
